...
< A list of dependencies used by the package with some explanation as to why they are required. Not all dependencies need to be explained. This section can also mention dependencies that are planned to be removed or added in future development. >
